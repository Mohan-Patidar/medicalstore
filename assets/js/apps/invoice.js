...
var $btns = $('.list-actions').click(function () {
  ...
  var setInvoiceNumber = getParentDiv.find('.invoice-inbox #delete-invoice').attr('onclick', 'deleteInvoice("' + getDataInvoiceAttr+'", "customer_invoice")');
  var editinvoice = getParentDiv.find('.invoice-inbox #edit-invoice').attr('href', 'edit-invoice?id='+getDataInvoiceAttr);
